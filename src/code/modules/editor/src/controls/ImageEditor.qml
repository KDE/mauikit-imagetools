    ...
    ITE.ImageItem
    {
        ...
        Row
        {
            ...
            Slider
            {
                ...
                from: -100
                to: 100
                value: imageDoc.brightness
                live: false
                stepSize: 1

                onMoved: imageDoc.adjustBrightness(value)
            }

            Button
            {
                text: "brightness at " + imageDoc.brightness

                onClicked: imageDoc.adjustBrightness(60)
            }
            ...
            Button
            {
                ...
                onClicked: imageDoc.adjustBrightness(-87)
            }
            ...
            Button
            {
                ...
                onClicked: imageDoc.adjustBrightness(20)
            }

            Button
            {
                text: "contrast at " + imageDoc.contrast

                onClicked: imageDoc.adjustContrast(-150)
            }


            Button
            {
                text: "saturation at " + imageDoc.contrast

                onClicked: imageDoc.adjustSaturation(-150)
            }

            Button
            {
                text: "undo" - "brightness at " + imageDoc.brightness
                onClicked:
                {
                    _doc.undo()
                    _slider.value =  imageDoc.brightness
