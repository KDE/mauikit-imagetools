...
MouseArea {
    ...
    implicitWidth: graphics.implicitWidth + Maui.Style.space.large* 2
    implicitHeight: graphics.implicitHeight + Maui.Style.space.large* 2
    ...
    Rectangle {
        id: graphics
        visible: false
        implicitWidth: Maui.Style.units.gridUnit + Maui.Style.units.gridUnit % 2
        implicitHeight: Maui.Style.units.gridUnit + Maui.Style.units.gridUnit % 2
